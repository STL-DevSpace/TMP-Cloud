package org.dromara.projects.enums;
...
public enum TrainingTaskStatus {
    ...
    // 添加状态码映射（可根据实际需求调整）
    private static final Map<String, TrainingTaskStatus> NAME_TO_ENUM_MAP =
     ...
     */
    public static TrainingTaskStatus fromName(String name) {
